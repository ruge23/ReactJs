...
Ejecutemos `webpack` y veamos como queda nuestra APP que ahora tiene Bootstrap:
...
![navBootstrap](./img/navBootstrap.gif)
...
Ahora si probamos nuestra página:

![navQuery](./img/navjQuery.gif)
  ...
  render: function(){
    return (
      <div className= {s.prueba}>
        <h1 className={s.title}>Hola, Plataforma5!!</h1>
